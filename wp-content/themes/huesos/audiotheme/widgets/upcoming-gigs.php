...
?>
	...
	<footer>
		<a href="<?php echo esc_url( get_post_type_archive_link( 'audiotheme_gig' ) ); ?>" class="more-link"><?php _e( 'More', 'huesos' ); ?>&hellip;</a>
	</footer>

<?php else : ?>

	<p class="no-results">
		<?php _e( 'No gigs are currently scheduled.', 'huesos' ); ?>
	</p>
