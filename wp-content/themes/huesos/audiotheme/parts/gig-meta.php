...
<h2 class="gig-date-time">
	<span class="gig-date date">
		...
		<time datetime="<?php echo get_audiotheme_gig_time( 'c' ); ?>">
			<?php echo get_audiotheme_gig_time( get_option( 'date_format', 'F d, Y' ) ); ?>
		</time>
	</span>

	<span class="gig-time"><?php echo get_audiotheme_gig_time( '', 'g:i A', false, array( 'empty_time' => __( 'TBD', 'huesos' ) ) ); ?></span>
</h2>
