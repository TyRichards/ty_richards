...
<section class="no-results not-found">
	...
	?>
		...
		<header class="page-header">
			<h1 class="page-title"><?php _e( 'Recent Shows', 'huesos' ); ?></h1>
		</header>

		<div class="page-content">
			<p><em><?php _e( "There currently aren't any scheduled shows. Check back soon!", 'huesos' ); ?></em></p>
		</div>

		<article id="gigs" class="gig-list vcalendar">
			<header class="gig-list-header">
				<span class="gig-list-date"><?php _e( 'Date', 'huesos' ); ?></span>
				<span class="gig-list-location"><?php _e( 'Location', 'huesos' ); ?></span>
			</header>
	...
	<?php else : ?>
		...
		<div class="page-content">
			...
			<p>
				<?php _e( "There currently aren't any scheduled shows. Check back soon!", 'huesos' ); ?>
			</p>
		</div>
