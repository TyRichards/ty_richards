...
<?php if ( audiotheme_gig_has_venue() ) : ?>
	...
	<dd class="gig-permalink">
		<a href="<?php the_permalink(); ?>">
			<span class="screen-reader-text"><?php _e( 'More', 'huesos' ); ?></span>
		</a>
	</dd>
...
<?php else : ?>
	...
	<dt class="gig-venue">
		<span class="gig-title"><?php _e( 'Gig venue details are missing or incomplete.', 'huesos' ); ?></span>
...
<dd class="gig-date date">
	...
	<time class="dtstart" datetime="<?php echo get_audiotheme_gig_time( 'c' ); ?>">
		<?php echo get_audiotheme_gig_time( get_option( 'date_format', 'M d, Y' ) ); ?>
	</time>
</dd>
